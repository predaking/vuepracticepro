...
export default {
  ...
  data() {
    return {
      // 定义当前行列指针位置
      s00: {
        backgroundImage: 'url(' + require('../assets/Bird00.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s01: {
        backgroundImage: 'url(' + require('../assets/Bird01.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s02: {
        backgroundImage: 'url(' + require('../assets/Bird02.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s10: {
        backgroundImage: 'url(' + require('../assets/Bird10.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s11: {
        backgroundImage: 'url(' + require('../assets/Bird11.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s12: {
        backgroundImage: 'url(' + require('../assets/Bird12.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s20: {
        backgroundImage: 'url(' + require('../assets/Bird20.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s21: {
        backgroundImage: 'url(' + require('../assets/Bird21.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s22: {
        backgroundImage: 'url(' + require('../assets/Bird22.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      backgroundDiv: {
