...
export default {
  ...
  data() {
    return {
      // 定义当前行列指针位置
      s00: {
        backgroundImage: 'url(' + require('../assets/Dolphin00.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s01: {
        backgroundImage: 'url(' + require('../assets/Dolphin01.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s02: {
        backgroundImage: 'url(' + require('../assets/Dolphin02.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s10: {
        backgroundImage: 'url(' + require('../assets/Dolphin10.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s11: {
        backgroundImage: 'url(' + require('../assets/Dolphin11.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s12: {
        backgroundImage: 'url(' + require('../assets/Dolphin12.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s20: {
        backgroundImage: 'url(' + require('../assets/Dolphin20.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s21: {
        backgroundImage: 'url(' + require('../assets/Dolphin21.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s22: {
        backgroundImage: 'url(' + require('../assets/Dolphin22.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      backgroundDiv: {
