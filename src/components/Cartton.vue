...
export default {
  ...
  data() {
    return {
      // 定义当前行列指针位置
      s00: {
        backgroundImage: 'url(' + require('../assets/Cartton00.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s01: {
        backgroundImage: 'url(' + require('../assets/Cartton01.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s02: {
        backgroundImage: 'url(' + require('../assets/Cartton02.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s10: {
        backgroundImage: 'url(' + require('../assets/Cartton10.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s11: {
        backgroundImage: 'url(' + require('../assets/Cartton11.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s12: {
        backgroundImage: 'url(' + require('../assets/Cartton12.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s20: {
        backgroundImage: 'url(' + require('../assets/Cartton20.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s21: {
        backgroundImage: 'url(' + require('../assets/Cartton21.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      s22: {
        backgroundImage: 'url(' + require('../assets/Cartton22.png') + ')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '100% 100%'
      },
      backgroundDiv: {
